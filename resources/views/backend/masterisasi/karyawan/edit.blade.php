                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                {{ Form::open(['route'=>'karyawan.update' ,'method' => 'post', 'class'=>'form-horizontal mt-3  animated bounceIn','enctype'=>'multipart/form-data']) }} 
						        {{ Form::token() }}
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label text-right">Nama Lengkap</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" id="example-text-input" name="nama_karyawan" value="{{ @$rs->nama_karyawan }}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="number" id="example-tel-input" name="no_telepon" value="{{ @$rs->no_telepon }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control mdate" name="tgl_lahir" value="{{ @$rs->tgl_lahir }}" required>
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            <label for="example-datetime-local-input" class="col-sm-2 col-form-label text-right">Tgl. Masuk</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control mdate" name="tgl_masuk" value="{{ @$rs->tgl_masuk }}" required>
                                            </div>
                                        </div> 
                                        <div class="form-group row">
                                            <label for="example-datetime-local-input" class="col-sm-2 col-form-label text-right">Tgl. Keluar</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control mdate" name="tgl_keluar" value="{{ @$rs->tgl_keluar }}">
                                            </div>
                                        </div>  
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="gaji"  name="gaji" value="{{ @$rs->gaji }}" required>
                                                </div>
                                            </div>
                                        </div>  
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="uang_makan"  name="uang_makan" value="{{ @$rs->uang_makan }}" required>
                                                </div>
                                            </div>
                                        </div>  
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" rows="5" name="keterangan" required>{{ @$rs->keterangan }}</textarea>
                                            </div>
                                        </div>
